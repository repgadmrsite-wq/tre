...
<body class="dark-mode">
                        ...
                        <div id="map-panel" class="map-wrapper hidden">
                            <div class="map-chooser">
                                ...
                                <div class="poi-buttons">
                                    <button type="button" class="poi-btn" data-lat="26.5335" data-lng="53.9950">اسکله تفریحی</button>
                                    <button type="button" class="poi-btn" data-lat="26.5262" data-lng="53.9800">فرودگاه کیش</button>
                                    <button type="button" class="poi-btn" data-lat="26.5339" data-lng="53.9841">مرکز تجاری</button>
                                    <button type="button" id="geo-btn" class="poi-btn geo-btn">نزدیک‌ترین موتور به من</button>
                                </div>
                            </div>
                        </div>
                    </aside>
    ...
    <!-- Quick Reserve Modal -->
    <div id="quick-modal" class="qr-modal hidden" role="dialog" aria-modal="true" aria-labelledby="quick-title" tabindex="-1">
        <div class="qr-content">
            <h3 id="quick-title">تأیید رزرو فوری</h3>
            <p id="quick-model" class="mb-2"></p>
            <p id="quick-preview" class="mb-1"></p>
            <p id="quick-price" class="mb-3"></p>
            <button type="button" id="quick-edit" class="btn-glass outline mb-3">ویرایش</button>
            <div id="quick-edit-fields" class="hidden mb-3">
                <label for="quick-date" class="visually-hidden">تاریخ</label>
                <input type="text" id="quick-date" data-jdp>
                <label for="quick-time" class="visually-hidden">ساعت</label>
                <input type="time" id="quick-time" step="900">
            </div>
            <p class="qr-note">در صورت عدم تایید در ۵ دقیقه رزرو آزاد می‌شود</p>
            <div class="qr-actions">
                <button type="button" id="quick-confirm" class="btn-glass primary">تأیید و ادامه</button>
