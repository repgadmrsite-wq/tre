...
<section id="breadcrumb">
    ...
    <ul>
        ...
        <li><a href="https://www.persianmizban.com/about-us/">درباره ی پرشین میزبان</a>
    </ul>
    </div>
</section>
...
<section id="contact-links">
    <div class="container">
        <div class="box">
            <div class="grid cols-1 a-items-center" lg="cols-4">
                <div md="col-3">
                    <div class="w-full d-flex" i-lg="overflow-x-auto">
                        <a href="#history" class="button">تاریخچه فعالیت </a>
                        <a href="#our-team" class="button">خانواده پرشین میزبان </a>
                        <a href="#contact-mission" class="button">درباره ما </a>
                        <a href="#contact-us" class="button">تماس با ما </a>
                        <a href="https://www.persianmizban.com/card-number/" class="button">شماره حساب ها </a>
                    </div>
                </div>
                <div class="text-left pl-6 text-90" i-lg="d-none">
                    <div class="text-w-medium pt-1 -mb-1">ABOUT</div>
                    <div class="text-w-light">PERSIAN MIZBAN</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="grid cols-1 a-items-center" md="cols-4">
            <div md="col-3" class="py-4" >
                ...
                <div class="text-primary text-80 lh">
                    ...
                    <br>
                    ارائه زیرساخت خدمات دیتاسنتر، میزبانی وب، ثبت دامنه، سرور مجازی و سرور اختصاصی با اولویت <b><u>خلق ارزش</u></b> برای مشتریان، عمده‌ترین فعالیت ما است.
                </div>
            </div>
            <div i-md="d-none" >
                <div class="image">
...
<section id="our-team">
    ...
    <div class="container mt-40">
        ...
        <div class="swiper emp-swiper-slider1 p-relative" >
            <div class="prev"></div>
            <div class="next"></div>
        ...
        <div class="swiper emp-swiper-slider2 p-relative" >
            <div class="prev"></div>
            <div class="next"></div>
            <div class="swiper-wrapper">
        ...
        <div class="grid cols-1 a-items-center" lg="cols-5">
            <div lg="col-2" >
                ...
                <ul class="text-90">
                    ...
                    <li>متمرکز در کیفیت</li>
                    <li>تسهیل ارائه خدمات زیرساخت برای کسب‌وکارها</li>
                </ul>
            </div>
                ...
                <div class="image">
                    ...
                    <div class="box">
                        <div class="text-w-medium">
                            <div class="text-primary -mb-3" xl="text-120">ارائـه خدمات</div>
                            <div class="text-orange -mb-2" xl="text-150">پرقدرت و پرسرعت</div>
                            <div class="opacity-50 text-60" xl="text-80">از ســرور های در سراســر جهان</div>
                            <div class="idk"></div>
                            <div class="idk2"></div>
                        </div>
                    </div>
...
در همون اوایل راه، مزه سخت کوشی و کار بی وقفه را چشیدیم و شب‌ها و روزهای زیادی رو داخل شرکت خوابیدیم و زندگی کردیم و دوران نوجوانی و جوانی زندگی خودمون رو تو پرشین میزبان خلاصه کردیم.</br>دوستان زیادی رو توی این مدت کنار خودمون داشتیم که با هم شب و روز گذروندیم، بزرگ شدیم، پدر و مادر شدیم و هم پیمان شدیم. هنوز هم مثل همون روزهای اول و به عشق همون چالش‌ها، به سمت خانواده بزرگمون تو پرشین میزبان حرکت می‌کنیم.
                </div>
            </div>
        </div>
    </div>
