...
<html lang="fa-IR">
<head>
    <title>سرور ایران، خرید سرور مجازی ویندوز و لینوکس | پرشین میزبان</title>
    <meta name="description" content="سرور ایران، سرور مجازی ایران، سرور ویندوز و لینوکس با منابع کاملا اختصاصی و تحویل به صورت خودکار و آنی از پرشین میزبان" />
...
<section id="breadcrumb">
    ...
    <ul>
        ...
        <li><a href="https://www.persianmizban.com/vps/">خرید سرور</a>
                <li><a href="https://www.persianmizban.com/vps/iran">سرور ایران</a></li>
    </ul>
    </div>
</section>
                ...
                <div class="swiper-wrapper">
                        ...
                        <div lg="grid !cols-5 a-items-center" class="pt-10 pb-12"  >
                            <div lg="col-3 pt-15 pb-20">
                                <div class="text-orange text-170 text-w-bold mb-2" i-sm="text-130 mb-3" >
                                    سرور مجازی ایران، بستری پرسرعت
                                </div>
                                <div class="text-90 mb-5" >
                                    تجربه ی لذت بخش بـی نـهایت سرعت
                                </div>
                                <div class="text-80 text-lh-4">
                                    سرور مجازی ایران به دلیل نزدیک بودن محل سرور به لوکیشن کاربران ایرانی شما <b>پینگ</b> چند برابر مناسب تری را نسبت به سرور های خارج از ایران تجربه خواهید کرد. خرید سرور مجازی ایران ارزان قیمت بوده چراکه قیمت پلن های سرور مجازی ایران با تومان محاسبه میشود و تغییرات ارزی اثری روی آنها نخواهد داشت. با سرور مجازی ایران نهایت لذت را از عملکرد و کارایی سرور، تجربه خواهید کرد.
                                </div>
                            </div>
                            <div class="d-none" lg="col-2 d-block" >
                                <img src="img/iran-server.svg" alt="سرور ایران" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div lg="grid !cols-5 a-items-center" class="pt-10 pb-12"  >
                            <div lg="col-3 pt-15 pb-20">
                                <div class="text-orange text-170 text-w-bold mb-2" i-sm="text-130 mb-3" >
                                    خرید سرور مجازی ایران، بروز و قدرتمند
                                </div>
                                <div class="text-90 mb-5" >
                                    سرور مجازی ایران با بروز ترین سخت افزار و تکنولوژی های روز دنیا
                                </div>
                                <div class="text-80 text-lh-4">
                                    سرور های ایران از بروز ترین سخت افزار های روز دنیا برخوردار هستند، از جمله <span style="color: #ffcc00;"><b>RAM DDR4</b></span> و <span style="color: #ffcc00;"><b>CPU GOLD</b></span> در کنار هارد های پرسرعت <span style="color: #ffcc00;"><b>SSD NVMe دیتاسنتری</b></span> برخوردار هستند. همین طور سیستم ساخت و تحویل سرور ها به صورت خودکار و کاملا آنی توسط سیستم انجام میشود. این سری امکانات در کنار پنل بسیار کارامد مدیریتی می باشد، که در هر زمان امکان خاموش، روشن، ریست، تعویض رمز عبور و تعویض نسخه سیستم عامل و... را به کاربر میدهد، تا در کنار سرعت و قدرت سرور مجازی ایران مدیریتی شیرین را تجربه کند.
                                </div>
                            </div>
                            <div class="d-none" lg="col-2 d-block" >
                                <img src="img/vps-iran2.svg" alt="سرور مجازی" >
                            </div>
                        </div>
                    </div>
...
<section id="host-links">
    <div class="container-fluid" >
        <a href="https://www.persianmizban.com/vps/iran"><div class="button active" >سرور ایران</div></a>
...
<section id="host-plans">
    <div class="container">
        ...
        <div class="choose">
            ...
            <div data-tab="3"><div class="circle"></div>اسـتاندارد</div>
            <div data-tab="4" class="active"><div class="circle"></div>حـرفه ای</div>
            <div data-tab="5,6"><div class="circle"></div>شـرکتی</div>
        </div>
            ...
            <div class="grid cols-6" >
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="text-center text-85"><span class="opacity-50">IRAN VPS /</span> Plan <span
                                ...
                                <div class="button">
                                    <div class="icon"></div>
                                    <a href="https://www.persianmizban.com/my/cart.php?a=add&pid=42"><div class="mx-auto">ثبت سفارش</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button">
                                    <div class="icon"></div>
                                    <a href="https://www.persianmizban.com/my/cart.php?a=add&pid=43"><div class="mx-auto">ثبت سفارش</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-relative">
                    <div class="plan suggested">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                <div class="text-center text-120 text-w-semibold mb-2">پلن سـوم + نامحدود</div>
                                <div class="text-center text-85"><span class="opacity-50">IRAN VPS /</span> Plan <span
                                ...
                                <div class="button">
                                    <div class="icon"></div>
                                    <a href="https://www.persianmizban.com/my/cart.php?a=add&pid=44"><div class="mx-auto">ثبت سفارش</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-relative">
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            ...
                            <div class="content">
                                <div class="text-center text-120 text-w-semibold mb-2">پلن چـهارم + IpV6</div>
                                <div class="text-center text-85"><span class="opacity-50">IRAN VPS /</span> Plan <span
                                ...
                                <div class="button">
                                    <div class="icon"></div>
                                    <a href="https://www.persianmizban.com/my/cart.php?a=add&pid=45"><div class="mx-auto">ثبت سفارش</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-relative">
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                <div class="text-center text-120 text-w-semibold mb-2">پلن پـنجم + IpV6</div>
                                <div class="text-center text-85"><span class="opacity-50">IRAN VPS /</span> Plan <span
                                ...
                                <div class="button">
                                    <div class="icon"></div>
                                    <a href="https://www.persianmizban.com/my/cart.php?a=add&pid=46"><div class="mx-auto">ثبت سفارش</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button">
                                    <div class="icon"></div>
                                    <a href="https://www.persianmizban.com/my/cart.php?a=add&pid=47"><div class="mx-auto">ثبت سفارش</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <table>
            <tr>
                ...
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="https://www.persianmizban.com/my/cart.php?a=add&pid=42"><div class="in">پلن اول</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="https://www.persianmizban.com/my/cart.php?a=add&pid=43"><div class="in">پلن دوم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="https://www.persianmizban.com/my/cart.php?a=add&pid=44"><div class="in">پلن سـوم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="https://www.persianmizban.com/my/cart.php?a=add&pid=45"><div class="in">پلن چـهارم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="https://www.persianmizban.com/my/cart.php?a=add&pid=46"><div class="in">پلن پـنجم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="https://www.persianmizban.com/my/cart.php?a=add&pid=47"><div class="in">پلن شـشم</div></a>
                    </div>
                </td>
            </tr>
            <tr>
            ...
            <div class="tab tab-2">
                <div  class="grid cols-1" lg="cols-5">
                    <div lg="col-4" >
                        ...
                        <div class="text-90">
                            سرور ها در دیتاسنتر های درجه یک و استاندارد و در فول رک های اختصاصی پرشین میزبان کلوکلیشن شده اند، این فضا های اختصاصی <span style="color: #00ccff;"><b>شرکت میزبان داده فیدار</b></span> مجهز به دو لاین برق شهری و UPS به همراه برق اضطراری می باشند که <b><span style="color: #00ccff;">چالش قطعی برق دیتاسنتری</span></b> را به 0 رسانده است.</br>آپتایم شبکه سرور ها با دو لاین مجزا اینترنت از مرکز زیر ساخت امام خمینی به حداکثر رسیده، این بستر آماده و تجهیز برای میزبانی سایت و اپلیکیشن های پربازدید شده است.
                        </div>
                    </div>
                    <div i-lg="d-none" >
                        <div class="d-flex h-full j-content-center" i-lg="d-none">
