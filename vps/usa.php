<?php
$pageTitle = 'سرور آمریکا، خرید سرور مجازی ویندوز و لینوکس | پرشین میزبان';
$pageDescription = 'سرور آمریکا، سرور مجازی آمریکا، سرور ویندوز و لینوکس با منابع کاملا اختصاصی و تحویل به صورت خودکار و آنی از پرشین میزبان';
$breadcrumbs = [
    '/' => 'پرشین میزبان',
    '/vps/' => 'سرور مجازی',
...
?>
<h1 class="d-none">سرور مجازی آمریکا پرشین میزبان</h1>
                ...
                <div class="swiper-wrapper">
                        ...
                        <div lg="grid !cols-5 a-items-center" class="pt-10 pb-12"  >
                            <div lg="col-3 pt-15 pb-20">
                                <div class="text-orange text-170 text-w-bold mb-2" i-sm="text-130 mb-3" >
                                    سرور مجازی آمریکا، بستری پرسرعت
                                </div>
                                <div class="text-90 mb-5" >
                                    تجربه ی لذت بخش بـی نـهایت سرعت
                                </div>
                                <div class="text-80 text-lh-4">
                                    سرور مجازی آمریکا به دلیل کیفیت بالای شبکه و لوکیشن کاملا استاندارد و دیتاسنتر بسیار بروز و قدرتمند کارایی و عملکرد صد در صدی را برای شما خواهد داشت. با سرور مجازی آمریکا نهایت لذت را از عملکرد و کارایی سرور، تجربه خواهید کرد.
                                </div>
                            </div>
                            <div class="d-none" lg="col-2 d-block" >
                                <img src="/img/vps-usa.svg" width="990" height="1116" loading="lazy" alt="سرور آمریکا" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div lg="grid !cols-5 a-items-center" class="pt-10 pb-12"  >
                            <div lg="col-3 pt-15 pb-20">
                                <div class="text-orange text-170 text-w-bold mb-2" i-sm="text-130 mb-3" >
                                    خرید سرور مجازی آمریکا، بروز و قدرتمند
                                </div>
                                <div class="text-90 mb-5" >
                                    سرور مجازی آلمان با بروز ترین سخت افزار و تکنولوژی های روز دنیا
                                </div>
                                <div class="text-80 text-lh-4">
                                    سرور های آمریکا از بروز ترین سخت افزار های روز دنیا برخوردار هستند، از جمله <span style="color: #ffcc00;"><b>RAM DDR4</b></span> و <span style="color: #ffcc00;"><b>CPU GOLD</b></span> در کنار هارد های پرسرعت <span style="color: #ffcc00;"><b>SSD NVMe دیتاسنتری</b></span> برخوردار هستند. همین طور سیستم ساخت و تحویل سرور ها به صورت خودکار و کاملا آنی توسط سیستم انجام میشود. این سری امکانات در کنار پنل بسیار کارامد مدیریتی می باشد، که در هر زمان امکان خاموش، روشن، ریست، تعویض رمز عبور و تعویض نسخه سیستم عامل و... را به کاربر میدهد، تا در کنار سرعت و قدرت سرور مجازی آمریکا مدیریتی شیرین را تجربه کند.
                                </div>
                            </div>
                            <div class="d-none" lg="col-2 d-block" >
...
<section id="host-links">
    <div class="container-fluid" >
        ...
        <a href="<?php echo $baseUrl; ?>vps/usa"><div class="button active" >سرور آمریکا</div></a>
...
<section id="host-plans">
    <div class="container">
        ...
        <div class="choose">
            <div data-tab="1"><div class="circle"></div>اقـتصادی</div>
            <div data-tab="2" class="active"><div class="circle"></div>اسـتاندارد</div>
            <div data-tab="3"><div class="circle"></div>حـرفه ای</div>
        </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="text-center text-85"><span class="opacity-50">USA VPS /</span> Plan <span
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=75"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan suggested">
                        ...
                        <div class="plan-in">
                            ...
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=76"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=77"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <table>
            <tr>
                ...
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=75"><div class="in">پلن اول</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=76"><div class="in">پلن دوم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=77"><div class="in">پلن سـوم</div></a>
                    </div>
                </td>
            </tr>
            <tr>
