<?php
$pageTitle = 'خرید سرور، سرور مجازی، سرور مجازی ایران، آلمان، آمریکا و فنلاند| پرشین میزبان';
                    ...
                    <div class="swiper-slide">
                        <div lg="grid cols-5 a-items-center" class="pt-10 pb-12"  >
                            ...
                            <div class="d-none" lg="col-2 d-block" >
                                <img src="/img/vps-all.png" width="1434" height="1276" loading="lazy" alt="خرید سرور" >
                            </div>
                        </div>
                    </div>
                        <div class="swiper-slide">
                        <div lg="grid cols-5 a-items-center" class="pt-10 pb-12"  >
                            ...
                            <div class="d-none" lg="col-2 d-block" >
                                <img src="/img/vps-all2.png" width="435" height="367" loading="lazy" alt="سرور مجازی" >
                            </div>
                        </div>
                    </div>
