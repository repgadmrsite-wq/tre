<?php
$pageTitle = 'سرور فنلاند، خرید سرور مجازی ویندوز و لینوکس | پرشین میزبان';
$pageDescription = 'سرور فنلاند، سرور مجازی فنلاند، سرور ویندوز و لینوکس با منابع کاملا اختصاصی و تحویل به صورت خودکار و آنی از پرشین میزبان';
$breadcrumbs = [
    '/' => 'پرشین میزبان',
    '/vps/' => 'سرور مجازی',
...
?>
<h1 class="d-none">سرور مجازی فنلاند پرشین میزبان</h1>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div lg="grid !cols-5 a-items-center" class="pt-10 pb-12"  >
                            ...
                            <div class="d-none" lg="col-2 d-block" >
                                <img src="/img/vps-finland.svg" width="990" height="1116" loading="lazy" alt="سرور فنلاند" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <div lg="grid !cols-5 a-items-center" class="pt-10 pb-12"  >
                            ...
                            <div class="d-none" lg="col-2 d-block" >
                                <img src="/img/vpsgermany.svg" width="1097" height="1039" loading="lazy" alt="سرور مجازی" >
                            </div>
                        </div>
                    </div>
...
<section id="host-links">
    <div class="container-fluid" >
        <a href="<?php echo $baseUrl; ?>vps/iran"><div class="button" >سرور ایران</div></a>
        <a href="<?php echo $baseUrl; ?>vps/germany"><div class="button" >سرور آلمان</div></a>
        <a href="<?php echo $baseUrl; ?>vps/usa"><div class="button" >سرور آمریکا</div></a>
        <a href="<?php echo $baseUrl; ?>vps/finland"><div class="button active" >سرور فنلاند</div></a>
    </div>
</section>
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=65"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=66"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan suggested">
                        ...
                        <div class="plan-in">
                            ...
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=67"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=68"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=69"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=70"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=71"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=72"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=73"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=74"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <table>
            <tr>
                ...
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=65"><div class="in">پلن اول</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=66"><div class="in">پلن دوم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=67"><div class="in">پلن سـوم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=68"><div class="in">پلن چـهارم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=69"><div class="in">پلن پـنجم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=70"><div class="in">پلن شـشم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=71"><div class="in">پلن هـفتم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=72"><div class="in">پلن هـشتم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=73"><div class="in">پلن نـهم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=74"><div class="in">پلن دهـم</div></a>
                    </div>
                </td>
            </tr>
            <tr>
