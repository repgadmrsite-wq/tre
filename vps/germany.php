<?php
$pageTitle = 'سرور آلمان، خرید سرور مجازی ویندوز و لینوکس | پرشین میزبان';
$pageDescription = 'سرور آلمان، سرور مجازی آلمان، سرور ویندوز و لینوکس با منابع کاملا اختصاصی و تحویل به صورت خودکار و آنی از پرشین میزبان';
$breadcrumbs = [
    '/' => 'پرشین میزبان',
    '/vps/' => 'سرور مجازی',
...
?>
<h1 class="d-none">سرور مجازی آلمان پرشین میزبان</h1>
...
<section id="host-links">
    <div class="container-fluid" >
        ...
        <a href="<?php echo $baseUrl; ?>vps/germany"><div class="button active" >سرور آلمان</div></a>
        <a href="<?php echo $baseUrl; ?>vps/usa"><div class="button" >سرور آمریکا</div></a>
        <a href="<?php echo $baseUrl; ?>vps/finland"><div class="button" >سرور فنلاند</div></a>
    </div>
</section>
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=48"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=50"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan suggested">
                        ...
                        <div class="plan-in">
                            ...
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=51"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=52"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=53"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=54"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=55"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=56"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=57"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="plan">
                        ...
                        <div class="plan-in">
                            <div class="content">
                                ...
                                <div class="button button-f">
                                    <div class="icon"></div>
                                    <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=58"><div class="mx-auto">تکمیل ظرفیت</div></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <table>
            <tr>
                ...
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=48"><div class="in">پلن اول</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=50"><div class="in">پلن دوم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=51"><div class="in">پلن سـوم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=52"><div class="in">پلن چـهارم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=53"><div class="in">پلن پـنجم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=54"><div class="in">پلن شـشم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=55"><div class="in">پلن هـفتم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=56"><div class="in">پلن هـشتم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=57"><div class="in">پلن نـهم</div></a>
                    </div>
                </td>
                <td class="!border-bottom-none">
                    <div class="title">
                        <a href="<?php echo $baseUrl; ?>my/cart.php?a=add&pid=58"><div class="in">پلن دهـم</div></a>
                    </div>
                </td>
            </tr>
            <tr>
