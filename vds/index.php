...
<html lang="fa-IR">
<head>
    <title>خرید سرور اختصاصی، سرور اختصاصی، سرور اختصاصی ایران، آلمان، هلند و فرانسه | پرشین میزبان</title>
        ...
        <div class="d-flex" >
            ...
            <div class="nav-mid">
                <ul>
                    ...
                    <li>
                        <a href="https://www.persianmizban.com/my/submitticket.php">تماس با ما</a>
                    </li>
                </ul>
                    ...
                    <div class="swiper-slide">
                        <div lg="grid cols-5 a-items-center" class="pt-10 pb-12"  >
                            <div lg="col-3 pt-15 pb-20">
                                <div class="text-orange text-170 text-w-bold mb-2" i-sm="text-130 mb-3" >
                                   سرور اختصاصی پرشین میزبان؛ بستری قدرتمند
                                </div>
                                <div class="text-90 mb-5" >
                                   خرید سرور اختصاصی با سخت افزار مدرن و شبکه ای مستحکم
                                </div>
                                <div class="text-80 text-lh-4">
                                    خرید سرور اختصاصی مطمئن و با منابع بالا و پایداری کافی، قدم نهایی شما برای گسترش کسب و کار انلاینتان در دنیای تجارت حرفه ای و رهایی از شر محدودیت های میزبانی وب معمولی است. با این وجود که بنا به نوع استفاده و نیازتان میتوانید از <b>لوکیشن های مختلف</b> هوشمندانه و خودکار سرور اختصاصی سفارش و تحویل بگیرید.
                                </div>
                            </div>
                        ...
                        <div lg="grid cols-5 a-items-center" class="pt-10 pb-12"  >
                            <div lg="col-3 pt-15 pb-20">
                                ...
                                <div class="text-80 text-lh-4">
                                    <b>قانون شماره یک</b> در پرشین میزبان ارایه ی منابع اختصاصی و مدرن در تمام سرویس ها به خصوص در سرور های اختصاصی می باشد. با ارایه ی منابع اختصاصی کیفیت چند برابری و ثابت را تجربه میکنید.
                                </div>
                            </div>
                            <div class="d-none" lg="col-2 d-block" >
            ...
            <div class="grid cols-5 a-items-center" >
                <div class="p-relative">
                    <div class="icon-area">
                        <div class="icon-circle">
                            <div class="icon-circle-in">
                                <div class="icon" >
                                    <img src="../img/vdsiran.png" alt="سرور ایران">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="en-title" >
                        ...
                        <div class="text-w-light text-70 opacity-50" >DEDICATED SERVER</div>
                    </div>
                </div>
                <div class="col-5" lg="col-3 pa-5" >
                    <div class="text-150 text-primary text-w-semibold ts-300 mb-4" parent-hover="text-(#f43741)">سرور اختصاصی ایران</div>
        ...
        <div class="box parent invert" >
            <div class="box-in" >
                <div class="grid cols-5 a-items-center" >
                    <div class="p-relative">
                        <div class="icon-area">
                            <div class="icon-circle">
                                <div class="icon-circle-in">
                                    <div class="icon" >
                                        <img src="../img/vdsgermany.png"alt="سرور آلمان">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-5" lg="col-3 pa-5" >
                        <div class="text-150 text-primary text-w-semibold ts-300 mb-4" parent-hover="text-(#f43741)">سرور اختصاصی آلمان</div>
                        <div class="text-90 text-lh-5 text-w-light">
        ...
        <div class="box parent invert" >
            <div class="box-in" >
                <div class="grid cols-5 a-items-center" >
                    <div class="p-relative">
                        <div class="icon-area">
                            <div class="icon-circle">
                                <div class="icon-circle-in">
                                    <div class="icon" >
                                        <img src="../img/vdsusa.png"alt="سرور آمریکا">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-5" lg="col-3 pa-5" >
                        <div class="text-150 text-primary text-w-semibold ts-300 mb-4" parent-hover="text-(#f43741)">سرور اختصاصی آمریکا</div>
                        <div class="text-90 text-lh-5 text-w-light">
                    ...
                    <div class="p-relative">
                        <div class="icon-area">
                            <div class="icon-circle">
                                <div class="icon-circle-in">
                                    <div class="icon" >
                                        <img src="../img/vdsnetherlands.png" alt="سرور فنلاند">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="en-title" >
                            <div class="text-primary text-w-semibold ts-300" parent-hover="text-(#f43741)" >NETHERLANDS</div>
                            <div class="text-w-light text-70 opacity-50" >DEDICATED SERVER</div>
                        </div>
                    </div>
                    <div class="col-5" lg="col-3 pa-5" >
                        <div class="text-150 text-primary text-w-semibold ts-300 mb-4" parent-hover="text-(#f43741)">سرور اختصاصی هلند</div>
                        <div class="text-90 text-lh-5 text-w-light">
                    ...
                    <div class="p-relative">
                        <div class="icon-area">
                            <div class="icon-circle">
                                <div class="icon-circle-in">
                                    <div class="icon" >
                                        <img src="../img/vdsbritain.png" alt="سرور فنلاند">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="en-title" >
                            <div class="text-primary text-w-semibold ts-300" parent-hover="text-(#f43741)" >UNITED KINGDOM</div>
                            <div class="text-w-light text-70 opacity-50" >DEDICATED SERVER</div>
                        </div>
                    </div>
                    <div class="col-5" lg="col-3 pa-5" >
                        <div class="text-150 text-primary text-w-semibold ts-300 mb-4" parent-hover="text-(#f43741)">سرور اختصاصی انگلستان</div>
                        <div class="text-90 text-lh-5 text-w-light">
                            سرور مجازی فنلاند لوکیشن بسیار پرسرعت و با پایداری بالا می باشد. همین طور این لوکیشن پینگ مناسبی نسبت به کاربران ایرانی دارد. سرور مجازی فنلاند مناسب برای میزبانی سایت و اپلیکیشن هایی است که تمایل دارند در لوکیشن خارج از ایران میزبانی شوند.
                        </div>
                    </div>
                    ...
                    <div class="p-relative">
                        <div class="icon-area">
                            <div class="icon-circle">
                                <div class="icon-circle-in">
                                    <div class="icon" >
                                        <img src="../img/vdsfrance.png" alt="سرور فنلاند">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="en-title" >
                            <div class="text-primary text-w-semibold ts-300" parent-hover="text-(#f43741)" >FRANCE</div>
                            <div class="text-w-light text-70 opacity-50" >DEDICATED SERVER</div>
                        </div>
                    </div>
                    <div class="col-5" lg="col-3 pa-5" >
                        <div class="text-150 text-primary text-w-semibold ts-300 mb-4" parent-hover="text-(#f43741)">سرور اختصاصی فرانسه</div>
                        <div class="text-90 text-lh-5 text-w-light">
                            سرور مجازی فنلاند لوکیشن بسیار پرسرعت و با پایداری بالا می باشد. همین طور این لوکیشن پینگ مناسبی نسبت به کاربران ایرانی دارد. سرور مجازی فنلاند مناسب برای میزبانی سایت و اپلیکیشن هایی است که تمایل دارند در لوکیشن خارج از ایران میزبانی شوند.
                        </div>
                    </div>
        ...
        <div class="box parent invert" >
            <div class="box-in" >
                <div class="grid cols-5 a-items-center" >
                    ...
                    <div class="col-5" lg="col-3 pa-5" >
                        <div class="text-150 text-primary text-w-semibold ts-300 mb-4" parent-hover="text-(#f43741)">سرور اختصاصی فنلاند</div>
                        <div class="text-90 text-lh-5 text-w-light">
                            سرور مجازی فنلاند لوکیشن بسیار پرسرعت و با پایداری بالا می باشد. همین طور این لوکیشن پینگ مناسبی نسبت به کاربران ایرانی دارد. سرور مجازی فنلاند مناسب برای میزبانی سایت و اپلیکیشن هایی است که تمایل دارند در لوکیشن خارج از ایران میزبانی شوند.
                        </div>
                    </div>
    ...
    <div class="container" >
        <div class="p-relative" >
            <div class="d-flex mb-8 pl-2" >
                ...
                <div class="button">
                    <a href="https://www.persianmizban.com/my/submitticket.php?step=2&deptid=5"><div>ارسال نظر</div></a>
                </div>
            </div>
...
<script type="text/javascript">window.$crisp=[];window.CRISP_WEBSITE_ID="62af99ce-3dde-4bb9-9ed1-f7f2a5ec5148";(function(){d=document;s=d.createElement("script");s.src="https://client.crisp.chat/l.js";s.async=1;d.getElementsByTagName("head")[0].appendChild(s);})();</script>
