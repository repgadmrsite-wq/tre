                    ...
                    <div class="swiper-slide">
                        <div lg="grid cols-5 a-items-center" class="pt-10 pb-12"  >
                            ...
                            <div class="d-none" lg="col-2 d-block" >
                                <img src="/img/hosts-all.svg" width="347" height="409" loading="lazy" alt="خرید هاست" >
                            </div>
                        </div>
                    </div>
                        <div class="swiper-slide">
                        <div lg="grid cols-5 a-items-center" class="pt-10 pb-12"  >
                            ...
                            <div class="d-none" lg="col-2 d-block" >
                                <img src="/img/security01.svg" width="472" height="468" loading="lazy" alt="هاست" >
                            </div>
                        </div>
                    </div>
    ...
    <div class="container p-relative" >
        <div class="swiper host-swiper-fslider" >
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <img src="/img/img-host-features.jpg" width="301" height="479" loading="lazy" alt="خرید هاست" class="human">
                </div>
