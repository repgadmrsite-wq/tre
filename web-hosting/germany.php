...
?>
<h1 class="d-none">هاست آلمان پرشین میزبان</h1>
                    ...
                    <div class="swiper-slide">
                        <div lg="grid cols-5 a-items-center" class="pt-10 pb-12"  >
                            ...
                            <div class="d-none" lg="col-2 d-block" >
                                <img src="/img/hosthgm.svg" width="349" height="820" loading="lazy" alt="هاست آلمان" >
                            </div>
                        </div>
                    </div>
                        <div class="swiper-slide">
...
<b>همان طور که گفنتیم اینجا تمام تمرکزتان را روی پیشرفت کسب و کارتون بزاید، <span style="color: #c3c3c3;">ما با افتخار در کنار شما هستیم...</span></b>
                            ...
                            <div class="d-none" lg="col-2 d-block" >
                                <img src="/img/hosthgm.png" width="1147" height="1070" loading="lazy" alt="خرید هاست آلمان" >
                            </div>
                        </div>
                    </div>
    ...
    <div class="container">
        <div class="grid cols-11 a-items-center pb-12">
            <div i-lg="d-none" class="col-3">
                <img src="/img/host-germany.svg" width="15" height="15" loading="lazy" alt="هاست آلمان" class="w-full">
            </div>
