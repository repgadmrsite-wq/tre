...
?>
<h1 class="d-none">هاست دانلود آلمان پرشین میزبان</h1>
                    ...
                    <div class="swiper-slide">
                        <div lg="grid cols-5 a-items-center" class="pt-10 pb-12"  >
                            ...
                            <div class="d-none" lg="col-2 d-block" >
                                <img src="/img/hostdlgm-s.svg" width="533" height="390" loading="lazy" alt="هاست دانلود آلمان" >
                            </div>
                        </div>
                    </div>
                        <div class="swiper-slide">
    ...
    <div class="container">
        <div class="grid cols-11 a-items-center pb-12">
            <div i-lg="d-none" class="col-3">
                <img src="/img/hostdlgermany.svg" width="1059" height="980" loading="lazy" alt="هاست دانلود" class="w-full">
            </div>
