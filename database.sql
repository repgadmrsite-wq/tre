...
INSERT INTO motorcycles (model, plate, color, capacity, battery_kwh, range_km, top_speed, weight, description, status, price_per_hour, price_half_day, price_per_day, price_per_week, price_per_month, insurance, year, mileage, available, is_special, lat, lng) VALUES
('اسکوتر وسپا', '11ک123-45', 'قرمز', 150, 4, 60, 45, 95, 'اسکوتر شهری', 'active', 30000, 70000, 120000, 750000, 2800000, 'بیمه شخص ثالث', 2022, 5000, 1, 0, 26.5332, 53.9986),
('موتور کروزر', '22د456-78', 'مشکی', 250, 6, 80, 70, 150, 'کروز با قدرت بالا', 'maintenance', 50000, 110000, 180000, 1100000, 4000000, 'بیمه کامل', 2021, 12000, 0, 0, 26.5358, 53.9891),
('موتور برقی', '33ه789-01', 'سفید', 100, 5, 90, 55, 110, 'برقی کم صدا', 'active', 20000, 50000, 90000, 550000, 2000000, 'بیمه پایه', 2023, 2000, 1, 1, 26.5387, 54.0035);
