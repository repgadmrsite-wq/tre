...
<h1 class="d-none">تماس با پرشین میزبان</h1>
                    <div class="image image2">
                        <img loading="lazy" src="/img/img-employee2.png" alt="تماس با ما" width="131" height="190">
                    </div>
...
<section id="contact-comments">
    ...
    <div class="container">
        ...
        <div class="list">
            <div class="comment">
                <div class="image">
                    <img loading="lazy" src="/profile/cb.png" alt="کاربر" width="57" height="57" />
                </div>
            ...
            <div class="comment">
                <div class="image">
                    <img loading="lazy" src="/profile/co.png" alt="کاربر" width="57" height="57" />
                </div>
                <div class="grid cols-1 text-90 text-primary mb-2" sm="cols-2">
                    <div class="text-w-medium">
                        رویا حیاتی
            ...
            <div class="comment">
                <div class="image">
                    <img loading="lazy" src="/profile/cw.png" alt="کاربر" width="57" height="57" />
                </div>
                <div class="grid cols-1 text-90 text-primary mb-2" sm="cols-2">
                    <div class="text-w-medium">
                        شهردخت اللهیاری
            ...
            <div class="comment">
                <div class="image">
                    <img loading="lazy" src="/profile/cr.png" alt="کاربر" width="57" height="57" />
                </div>
                <div class="grid cols-1 text-90 text-primary mb-2" sm="cols-2">
                    <div class="text-w-medium">
                        داراب دیباج
